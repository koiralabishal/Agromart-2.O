...
import { FaLeaf, FaBoxOpen, FaClipboardList, FaChartBar, FaUserCircle, FaSignOutAlt } from 'react-icons/fa';
    ...
    <div style={styles.dashboardContainer}>
      <aside style={styles.sidebar}>
        ...
        <nav style={styles.nav}>
          <div style={{...styles.navItem, ...styles.activeItem}}><FaChartBar /> Inventory Stats</div>
          <div style={styles.navItem}><FaBoxOpen /> Products</div>
          <div style={styles.navItem}><FaClipboardList /> Supply History</div>
          <div 
      ...
      <main style={styles.content}>
        ...
        <section style={styles.welcomeSection}>
          ...
          <p>Everything is stocked and ready for delivery.</p>
        </section>
      </main>
    </div>
  );
...
const styles = {
  dashboardContainer: { display: 'flex', minHeight: '100vh', backgroundColor: '#fcfaf4' },
  sidebar: { width: '250px', backgroundColor: '#d4ac0d', color: 'white', padding: '2rem' },
