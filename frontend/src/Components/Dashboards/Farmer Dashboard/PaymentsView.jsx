    ...
    <div className="payments-view">
      ...
      <section className="pv-section">
        ...
        <p style={{ color: "#666", marginBottom: "1.5rem" }}>
          This is a read-only record of cash transactions (Total Received as
          Seller).
          <FaInfoCircle
        ...
        <div className="pv-table-container">
          <table className="pv-table">
            ...
            <tbody>
              {codTransactionsToShow.length === 0 ? (
                <tr>
                  <td
                    colSpan="7"
                    style={{ textAlign: "center", padding: "2rem" }}
          ...
          {codTransactionsToShow.length > itemsPerPage && (
            <Pagination
              currentPage={currentCodPage}
              totalItems={codTransactionsToShow.length}
              itemsPerPage={itemsPerPage}
