...
const SettingsView = () => {
  ...
  const handleSavePhoto = async () => {
    ...
    try {
      ...
      if (err.response) {
        ...
        console.log("No response from server. Check network/CORS.");
      }
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      ...
      setErrors({ email: err.response?.data?.message || "Failed to update profile" });
    } finally {
  ...
  const handleUpdatePassword = async () => {
    ...
    if (!passwordData.newPassword) {
      ...
      newErrors.newPassword = "Password must be at least 8 characters and alphanumeric";
    }
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      setErrors({ delete: err.response?.data?.message || "Failed to delete account. Please try again." });
    } finally {
      ...
      <div className="settings-card profile-card">
        <div className="profile-header-content">
          ...
          <div className="profile-btns-container">
            <button className="change-photo-btn" onClick={handlePhotoClick} disabled={loadingPhoto}>
              Change Photo
            </button>
            {selectedFile && (
              <button className="save-photo-btn" onClick={handleSavePhoto} disabled={loadingPhoto}>
                {loadingPhoto ? "Saving..." : "Save Photo"}
              </button>
            )}
            {errors.photo && <p className="error-text-inline">{errors.photo}</p>}
          </div>
        </div>
      </div>
      ...
      <div className="settings-card">
        ...
        <div className="form-grid">
          <div className="input-group">
            ...
            {errors.name ? (
              <p className="error-text-inline">{errors.name}</p>
            ) : (
